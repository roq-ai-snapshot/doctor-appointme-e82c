  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System v1 - Streamlining Your Health Journey by Simplifying Appointment Scheduling with Doctors. Your Health, Our Priority."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System v1 - Streamlining Your Health Journey by Simplifying Appointment Scheduling with Doctors. Your Health, Our Priority.`}
            </Text>
            <Box
