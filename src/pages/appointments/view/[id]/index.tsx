...
function AppointmentViewPage() {
  ...
  const queryParams = useMemo<{
    include: {
      user_appointment_patient_idTouser: boolean;
      clinic: boolean;
      user_appointment_healthcare_provider_idTouser: boolean;
    };
  }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user_appointment_patient_idTouser', 'clinic', 'user_appointment_healthcare_provider_idTouser'],
          id,
        },
        'appointment',
      ),
